...
import { ref } from "vue";
import NuevoLeadForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para agregar Nuevo Lead
import PropiedadForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para agregar Propiedad-tablaLeads
import VisitaForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para agregar Visitas-tablaLeads
import ObservacionForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para agregar Observaciones-tablaLeads
import EditarPropiedadForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para editar propiedad-tablaLeads
import VerPropiedadForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para ver propiedad-tablaLeads
import EditarVisitaForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para editar visita-tablaLeads
import VerVisitaForm from "~/components/asesor/NuevoLeadForm.vue";//Formulario para ver visita-tablaLeads
...
<!------------------------------------------------------TABLA DE LEADS----------------------------------------------------------------------->
    ...
    <div v-if="currentTab === 'Leads'" class="bg-white p-4 rounded-xl shadow-xl overflow-x-auto">
      ...
      <!--Generacion de  Filas al Ingresar Nuevos campos de datos -->
...
<!--------------------------------------------------- TABLA DE CITAS----------------------------------------------------------------------->
    ...
    <div
      v-else-if="currentTab === 'Citas'"
      class="bg-white p-4 rounded-xl shadow-xl overflow-x-auto"
    >
      <div
        class="grid grid-cols-10 gap-x-4 py-3 px-4 text-sm font-semibold text-gray-600 border-b border-gray-200"
      >
        <span>N°</span>
      ...
      <div class="divide-y divide-gray-100">
        <div
          v-for="n in 7"
          :key="'cita-' + n"
          class="grid grid-cols-10 gap-x-4 py-3 px-4 text-sm text-gray-800 min-h-[50px] items-center"
        >
          <span></span>
...
<!-----------------------------------------TABLA DE CLIENTES--------------------------------------------------------------->
    ...
    >
      ...
      <!-- Header -->
      <div
        class="grid grid-cols-11 gap-x-4 py-3 px-4 text-sm font-semibold text-gray-600 border-b border-gray-200"
      >
        <span class="col-span-2">Nombre Completo</span>
        <span>Contacto</span>
        <span>Fecha</span>
      ...
      <div class="divide-y divide-gray-100">
        <div
          v-for="n in 7"
          :key="'cliente-' + n"
          class="grid grid-cols-11 gap-x-4 py-3 px-4 text-sm text-gray-800 min-h-[50px] items-center"
        >
          <span class="col-span-2"></span>
          <span></span>
          <span></span>
