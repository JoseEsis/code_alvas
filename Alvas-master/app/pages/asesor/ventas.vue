...
<template>
  <div class="p-8">
    ...
    <div v-if="currentTab === 'Leads'">
      <div class="rounded-[20px] shadow-xl overflow-hidden border border-gray-200 overflow-x-auto">
        <div
    ...
    <NuevoLeadForm v-if="showModal" @close="showModal = false" @crear="guardarLead" />
    ...
    <VisitaForm v-if="showVisitaForm" :lead="selectedLead" @close="showVisitaForm = false" />
